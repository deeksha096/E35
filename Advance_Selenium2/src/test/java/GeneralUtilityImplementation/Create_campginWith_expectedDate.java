...
public class Create_campginWith_expectedDate {
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		FileInputStream fis1 = new FileInputStream("./src\\test\\resources\\my_exeldata_1.xlsx");
		...
		if(BROWSER.equals("chrome")) {
			...
			driver = new FirefoxDriver();
				...
				driver.findElement(By.name("expectedCloseDate")).sendKeys(jlib.expectedDate());
